        ...
        <div className="mt-auto pt-6">
          <SheetClose asChild>
            <Link
              ...
              className="group flex h-12 w-full items-center justify-between rounded-full bg-brand-navy pl-6 pr-2 text-sm font-medium text-white transition-colors hover:bg-brand-red"
            >
              Donate
